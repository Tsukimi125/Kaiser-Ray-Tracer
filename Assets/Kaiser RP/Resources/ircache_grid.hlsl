#ifndef IRCACHE_GRID_HLSL
#define IRCACHE_GRID_HLSL
...
{
    const float3 center = ircache_grid_center.xyz;
    ...
    const int3 cascade_origin = ircache_cascade_origin[cascade].xyz;
