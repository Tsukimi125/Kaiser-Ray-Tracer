...
{
    float w_sum; // 记录luminance(光线追踪一个方向计算出的Radiance越大，luminance越大) * weight的值
    uint payload; //记录水库像素位置
    float M; //记录该位置水库的容量
    float W; //weight,用于数学计算
